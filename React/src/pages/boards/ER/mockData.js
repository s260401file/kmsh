...
const MOCK_DATA = {
  ...
  // Patient 主要欄位：Triage 檢傷分級(院方真實 1/2/3，於畫面換算為 A/B/C 三級)、Isolation 隔離方式、
  ...
  Beds: [
    ...
    { BedId:"MER03", Zone:"第一診療區", Status:"occupied",    Patient:{ PatientName:"許○雯", Gender:"F", Age:28, ArrivalDate:"05/24", ArrivalTime:"10:30", Diagnosis:"Ankle fracture, R/O Malleolus #", Doctor:"林○泰醫師", Nurse:"周○娟護理師", Department:"骨科", MedRecord:"E601234571", BirthDate:"1998/09/11", Triage:3, Dnr:false, Isolation:"無", Observation:false, Awaiting:false, AwaitingType:null, TransferOut:false, TransferIn:false, Aad:false, Mbd:false, FallRisk:false, Allergy:true, Exam:true, Consult:false, Notes:"骨科門診安排後續" } },
    ...
    { BedId:"MER09", Zone:"第二診療區", Status:"observation", Patient:{ PatientName:"黃○珠", Gender:"F", Age:48, ArrivalDate:"05/24", ArrivalTime:"08:50", Diagnosis:"UTI, Pyelonephritis R/O, Fever 38.8°C", Doctor:"林○泰醫師", Nurse:"張○惠護理師", Department:"腎臟內科", MedRecord:"I001234575", BirthDate:"1978/04/06", Triage:3, Dnr:false, Isolation:"無", Observation:true, Awaiting:false, AwaitingType:null, TransferOut:false, TransferIn:false, Aad:false, Mbd:false, FallRisk:false, Allergy:true, Exam:true, Consult:false, Notes:"靜脈抗生素治療中" } },
    ...
    { BedId:"MER13", Zone:"第二診療區", Status:"occupied",    Patient:{ PatientName:"洪○成", Gender:"M", Age:22, ArrivalDate:"05/24", ArrivalTime:"11:40", Diagnosis:"Laceration wound, Right hand 2cm", Doctor:"陳○科醫師", Nurse:"李○婷護理師", Department:"急診外科", MedRecord:"J101234576", BirthDate:"2004/12/05", Triage:3, Dnr:false, Isolation:"無", Observation:false, Awaiting:false, AwaitingType:null, TransferOut:false, TransferIn:false, Aad:false, Mbd:false, FallRisk:false, Allergy:false, Exam:false, Consult:false, Notes:"傷口清創縫合完成，衛教後離院" } },
    { BedId:"OER01", Zone:"第一留觀區", Status:"observation", Patient:{ PatientName:"楊○美", Gender:"F", Age:71, ArrivalDate:"05/24", ArrivalTime:"04:20", Diagnosis:"Dizziness, Vertigo, R/O BPPV vs Central", Doctor:"陳○科醫師", Nurse:"李○婷護理師", Department:"神經內科", MedRecord:"M401234579", BirthDate:"1955/03/25", Triage:3, Dnr:false, Isolation:"無", Observation:true, Awaiting:false, AwaitingType:null, TransferOut:false, TransferIn:false, Aad:false, Mbd:false, FallRisk:true, Allergy:false, Exam:true, Consult:false, Notes:"頭部 MRI 待安排，症狀已明顯改善" } },
...
export function getStats(beds) {
  ...
  return {
    ...
    sevA:        occupied.filter(b => b.Patient?.Triage === 1).length,
    sevB:        occupied.filter(b => b.Patient?.Triage === 2).length,
    sevC:        occupied.filter(b => b.Patient?.Triage === 3).length,
