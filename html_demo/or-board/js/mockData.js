const MOCK_DATA = {
  ...
  Rooms: [
    ...
    // OR-02: 門診刀, 手術中
    { RoomId: "OR-02", Status: "in-surgery",
      Patient: {
        PatientName: "陳○芳", Gender: "F", Age: 42,
        MedRecord: "B301234602", BirthDate: "1984/07/23",
        Department: "婦產科",
        Diagnosis: "Uterine myoma, Menorrhagia",
        SurgeryName: "子宮鏡肌瘤切除術 Hysteroscopic Myomectomy",
        Doctor: "林○泰醫師", ScrubNurse: "周○娟護理師", CircNurse: "王○珊護理師",
        AnesType: "脊椎麻醉 (SA)",
        SurgerySource: "門診刀", SurgeryStatus: "手術中",
        ScheduledTime: "09:00", StartTime: "09:32", EndTime: null,
        Notes: "術前子宮鏡評估完成，子宮腔形態正常，子宮動脈未做栓塞"
      }
    },

    // OR-03: 急診刀, 手術中
    { RoomId: "OR-03", Status: "in-surgery",
      Patient: {
        PatientName: "張○強", Gender: "M", Age: 34,
        MedRecord: "C401234603", BirthDate: "1992/04/08",
        Department: "骨科",
        Diagnosis: "Right femur fracture, Displaced, MVA",
        SurgeryName: "右股骨骨折切開復位髓內釘固定術 ORIF",
        Doctor: "王○哲醫師", ScrubNurse: "張○惠護理師", CircNurse: "李○婷護理師",
        AnesType: "全身麻醉 (GA)",
        SurgerySource: "急診刀", SurgeryStatus: "手術中",
        ScheduledTime: "07:00", StartTime: "07:48", EndTime: null,
        Notes: "車禍傷患，術前血液備妥 2 單位，家屬已在等候區，創傷外科評估無胸腹內傷"
      }
    },
    ...
    { RoomId: "OR-05", Status: "prep",
      Patient: {
        ...
        Department: "心臟外科",
        Diagnosis: "Mitral valve regurgitation, Severe (MR grade IV)",
        SurgeryName: "二尖瓣置換術 MVR",
        Doctor: "黃○誠醫師", ScrubNurse: "周○娟護理師", CircNurse: "張○惠護理師",
        AnesType: "全身麻醉 (GA) + 體外循環",
        SurgerySource: "住院刀", SurgeryStatus: "準備中",
        ScheduledTime: "11:30", StartTime: null, EndTime: null,
        Notes: "心肺繞道機備妥，血液科會診完成，ICU 床位已預留，預計術程 4～5 小時"
      }
    },
    ...
    { RoomId: "OR-07", Status: "completed",
      Patient: {
        ...
        Department: "整形外科",
        Diagnosis: "Hypertrophic scar contracture, Left hand dorsum",
        SurgeryName: "左手攣縮疤痕鬆解植皮術",
        Doctor: "林○泰醫師", ScrubNurse: "王○珊護理師", CircNurse: "李○婷護理師",
        AnesType: "局部麻醉 (LA)",
        SurgerySource: "門診刀", SurgeryStatus: "已完成",
        ScheduledTime: "08:00", StartTime: "08:22", EndTime: "10:18",
        Notes: "手術順利完成，傷口縫合完畢，病人已轉至恢復室（PACU），神智清醒"
      }
    },
    ...
    { RoomId: "OR-08", Status: "in-surgery",
      Patient: {
        ...
        Department: "一般外科",
        Diagnosis: "Acute appendicitis, Perforated, Peritonitis",
        SurgeryName: "腹腔鏡闌尾切除術 Lap. Appendectomy",
        Doctor: "王○哲醫師", ScrubNurse: "張○惠護理師", CircNurse: "周○娟護理師",
        AnesType: "全身麻醉 (GA)",
        SurgerySource: "急診刀", SurgeryStatus: "手術中",
        ScheduledTime: "06:30", StartTime: "07:15", EndTime: null,
        Notes: "急診穿孔性闌尾炎合併腹膜炎，術前廣效抗生素預防性使用，腹部 CT 確認無腸阻塞"
      }
    },
