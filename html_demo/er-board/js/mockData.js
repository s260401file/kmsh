  ...
  Beds: [
    ...
    { BedId:"MER101", Zone:"負壓隔離室", Status:"isolation",
      Patient:{ PatientName:"陳○文", Gender:"M", Age:58,
                ...
                Department:"胸腔內科",
                MedRecord:"A201234567", BirthDate:"1968/03/12",
                Triage:2,
                Dnr:false, Isolation:"負壓隔離",
                Observation:false, Awaiting:true, AwaitingType:"隔離",
    ...
    { BedId:"MER102", Zone:"負壓隔離室", Status:"isolation",
      Patient:{ PatientName:"劉○婷", Gender:"F", Age:44,
                ...
                Department:"感染科",
                MedRecord:"B301234568", BirthDate:"1982/07/28",
                Triage:3,
                Dnr:false, Isolation:"負壓隔離",
    ...
    { BedId:"MER001", Zone:"急救室", Status:"occupied",
      Patient:{ PatientName:"王○進", Gender:"M", Age:73,
                ...
                Doctor:"黃○誠醫師", Nurse:"張○惠護理師",
                Department:"心臟內科",
                MedRecord:"C401234569", BirthDate:"1953/01/19",
                Triage:1,
    ...
    { BedId:"MER002", Zone:"第一診療區", Status:"occupied",
      Patient:{ PatientName:"蔡○明", Gender:"M", Age:35,
                ...
                Doctor:"王○哲醫師", Nurse:"李○婷護理師",
                Department:"一般外科",
                MedRecord:"D501234570", BirthDate:"1991/05/03",
                Triage:3,
                Dnr:false, Isolation:"無",
                Observation:false, Awaiting:true, AwaitingType:"一般",
                TransferOut:false, TransferIn:false,
                Aad:false, Mbd:false, Admitted:true, AdmBedNo:"W52-031",
                FallRisk:false, Allergy:false, Exam:true, Consult:true,
    ...
    { BedId:"MER005", Zone:"第一診療區", Status:"occupied",
      Patient:{ PatientName:"張○義", Gender:"M", Age:68,
                ...
                Doctor:"黃○誠醫師", Nurse:"張○惠護理師",
                Department:"神經內科",
                MedRecord:"F701234572", BirthDate:"1958/02/14",
                Triage:2,
                Dnr:false, Isolation:"無",
                Observation:false, Awaiting:true, AwaitingType:"加護",
    ...
    { BedId:"MER006", Zone:"第一診療區", Status:"observation",
      Patient:{ PatientName:"林○淑", Gender:"F", Age:62,
                ...
                Doctor:"陳○科醫師", Nurse:"李○婷護理師",
                Department:"心臟內科",
                MedRecord:"G801234573", BirthDate:"1964/11/30",
                Triage:3,
                Dnr:false, Isolation:"無",
                Observation:true, Awaiting:false, AwaitingType:null,
                TransferOut:false, TransferIn:false,
    ...
    { BedId:"MER008", Zone:"第二診療區", Status:"occupied",
      Patient:{ PatientName:"吳○偉", Gender:"M", Age:55,
                ...
                Doctor:"王○哲醫師", Nurse:"周○娟護理師",
                Department:"一般外科",
                MedRecord:"H901234574", BirthDate:"1971/08/22",
                Triage:3,
                Dnr:false, Isolation:"無",
                Observation:false, Awaiting:true, AwaitingType:"一般",
                TransferOut:false, TransferIn:false,
    ...
    { BedId:"MER011", Zone:"第二診療區", Status:"observation",
      Patient:{ PatientName:"彭○霞", Gender:"F", Age:76,
                ...
                Doctor:"黃○誠醫師", Nurse:"張○惠護理師",
                Department:"精神科",
                MedRecord:"K201234577", BirthDate:"1950/06/18",
                Triage:3,
                Dnr:true, Isolation:"無",
                Observation:true, Awaiting:false, AwaitingType:null,
                TransferOut:false, TransferIn:false,
                Aad:false, Mbd:false, Deceased:true,
    ...
    { BedId:"MER012", Zone:"第二診療區", Status:"awaiting",
      Patient:{ PatientName:"謝○宏", Gender:"M", Age:52,
                ...
                Doctor:"林○泰醫師", Nurse:"周○娟護理師",
                Department:"新陳代謝科",
                MedRecord:"L301234578", BirthDate:"1974/10/02",
                Triage:2,
                Dnr:false, Isolation:"無",
                Observation:false, Awaiting:true, AwaitingType:"加護",
                TransferOut:false, TransferIn:false,
    ...
    { BedId:"MER013", Zone:"第二診療區", Status:"occupied",
      Patient:{ PatientName:"洪○成", Gender:"M", Age:22,
                ...
                TransferOut:false, TransferIn:false,
                Aad:false, Mbd:false,
                FallRisk:false, Allergy:false, Exam:false, Consult:false,
    ...
    { BedId:"OER002", Zone:"第一留觀區", Status:"awaiting",
      Patient:{ PatientName:"許○輝", Gender:"M", Age:80,
                ...
                Doctor:"王○哲醫師", Nurse:"張○惠護理師",
                Department:"骨科",
                MedRecord:"N501234580", BirthDate:"1946/09/07",
                Triage:3,
                Dnr:false, Isolation:"無",
                Observation:true, Awaiting:true, AwaitingType:"一般",
                TransferOut:false, TransferIn:false,
                Aad:false, Mbd:false,
                FallRisk:true, Allergy:false, Exam:true, Consult:true,
                Notes:"骨科手術安排中，NPO 指示，家屬同意手術，術前準備進行中" } },

    // ── 待床/特殊留觀 ──
    { BedId:"MER993", Zone:"待床區", Status:"empty", Patient:null },

    { BedId:"MER992", Zone:"待床區", Status:"transfer",
      Patient:{ PatientName:"周○強", Gender:"M", Age:39,
                ArrivalDate:"05/24", ArrivalTime:"09:00",
                Diagnosis:"Minor head injury, GCS 15, No ICH on CT",
                Doctor:"黃○誠醫師", Nurse:"周○娟護理師",
                Department:"神經外科",
                MedRecord:"O601234581", BirthDate:"1987/11/13",
                Triage:3,
                Dnr:false, Isolation:"無",
                Observation:false, Awaiting:false, AwaitingType:null,
                TransferOut:true, TransferIn:false, TransferHospital:"聖馬爾定醫院",
                Aad:false, Mbd:false,
                FallRisk:false, Allergy:false, Exam:true, Consult:false,
                Notes:"CT 無出血，安排轉至聖馬爾定醫院神外門診追蹤，轉院手續進行中" } },

    { BedId:"MER991", Zone:"待床區", Status:"awaiting",
      Patient:{ PatientName:"鄭○成", Gender:"M", Age:67,
                ArrivalDate:"05/24", ArrivalTime:"06:00",
                Diagnosis:"COPD exacerbation, SpO2 88% on room air",
                Doctor:"陳○科醫師", Nurse:"李○婷護理師",
                Department:"胸腔內科",
...
function getStats(beds) {
  ...
  const attending = occupied.length;
