...
{
    /// <summary>查詢清單（可依 unitCode / category 篩選）</summary>
    Task<IEnumerable<TextItem>> GetAllAsync(string? unitCode = null, string? category = null, CancellationToken ct = default);
